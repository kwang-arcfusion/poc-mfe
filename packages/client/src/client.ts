...
// ✨ เพิ่มฟังก์ชัน searchCampaignsAndOffers
...
export const fetchPerformanceSummary = (filters: {
    ...
    // ✨ ปรับปรุงให้ส่ง offer_ids เป็น filter string list
...
export const fetchOverviewData = (
    dateRange: DateRange,
    channels: string[],
    offerFilters: string[] // ✨ เปลี่ยนชื่อ parameter เพื่อความชัดเจน
    ...
    // ✨ ปรับปรุงให้ส่ง offerFilters เป็น list of string
