...
export const mockStories: Story[] = [
  // --- Today's Stories (6) ---
  {
    ...
    kpi: {
      ...
      subtitle: 'ArcFusionElite Purchase',
  ...
  },
  {
    ...
    kpi: { value: '-15%', title: 'CTR', subtitle: 'Search Ads' },
    chartHighlightLabel: 'Today',
  ...
  },
  {
    ...
    kpi: { value: '+150%', title: 'Video Views', subtitle: 'Organic Post #123' },
    chartHighlightLabel: 'Today',
  ...
  // --- Yesterday's Stories (5) ---
  {
    ...
    kpi: { value: '-30%', title: 'ROAS', subtitle: 'Q3 Campaign' },
  ...
  },
  {
    ...
    timestamp: getDate(1),
    timeAgo: 'about 1 day ago',
    kpi: { value: '+5%', title: 'Impressions', subtitle: 'Display Network' },
    chartHighlightLabel: 'Yesterday',
